...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    myDronaAuthUserSubject.add(
      MyDronaAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MyDronaAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MyDronaAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MyDronaAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    myDronaAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
